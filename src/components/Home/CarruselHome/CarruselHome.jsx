...
const CarruselHome = () => {
  ...
  return (
    ...
    >
      <IconButton className="swiper-prev-custom" aria-label="boton para retroceder en carusel principal">
        <ArrowBackIosNewIcon />
      </IconButton>
      <IconButton className="swiper-next-custom" aria-label="boton para avanzar en carusel principal">
        <ArrowForwardIosIcon />
      </IconButton>
